...
**GPT**：ChatGPT有多好用就不需要我来解释了，写文档、写论文、写代码都可以让GPT来帮助你。当然，有些同学可能用不了ChatGPT，或者觉得GPT4o免费版的限额不够用，也可以考虑其他平替产品，如Google的Gemini，国产的Kimi AI、豆包、文心一言（不推荐使用，和前面几个的差距过大了）等。
